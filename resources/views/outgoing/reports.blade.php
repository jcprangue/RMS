...
<div style="align:center;bacground-color:red; width:100%" >
  ...
  <thead >
    ...
    <tr class="borderall" bgcolor="#ffc04c">
        ...
        @if ($data_cat->id == 17 || $data_cat->id == 5 || $data_cat->id == 8)
          <th class="borderall text-center" style="width: 350px;">Particulars</th>
        @elseif ($data_cat->id == 23)
          <th class="borderall text-center" style="width: 250px;">Name</th>
        @else
          <th class="borderall text-center" style="width: 150px;">Particulars</th>
        @endif
        ...
        @else
          ...
          @if ($data_cat->id == 1 || $data_cat->id == 6 || $data_cat->id == 4 || $data_cat->id == 9 || $data_cat->id == 12 || $data_cat->id == 13 || $data_cat->id == 14 || $data_cat->id == 15)
          ...
          @elseif ($data_cat->id == 2 )
            <th class="borderall text-center" style="width:250px !important;">Payee</th>

          @elseif ($data_cat->id == 7 || $data_cat->id == 16 || $data_cat->id == 10)
            <th class="borderall text-center" style="width:170px !important;">Payee</th>
          ...
          @elseif ($data_cat->id == 23)
            <th class="borderall text-center" style="width:150px !important;">Travel Destination</th>
            <th class="borderall text-center" style="width:120px !important;">Type of Vehicle</th>
            <th class="borderall text-center" style="width:180px !important;">Date of Travel</th>
        ...
        @if($data_cat->id == 23)
        <th class="borderall text-center" style="width:170px !important;">Remarks</th>
        @else
        <th class="borderall text-center" style="width:80px !important;">Remarks</th>
        @endif
        <th class="borderall text-center" style="width:60px !important;">Received</th>
    </tr>
  </thead>
 <tbody>
    <?php $x = 0; ?>
      ...
      <?php $x++; ?>
          ...
          <tr >
            ...
            @elseif ($data_cat->id == 23)
              <td class="bottom-thin-border text-left" style="width:250px !important;">
                <?php 
            ...
            @else
              <td class="bottom-thin-border text-left" style="width:150px !important;">{{ $value['particulars'] }}</td>
            @endif
            ...
            @else
              @if ($data_cat->id == 1 || $data_cat->id == 6 || $data_cat->id == 4 || $data_cat->id == 9 || $data_cat->id == 12 || $data_cat->id == 13 || $data_cat->id == 14 || $data_cat->id == 15)
                <td class="bottom-thin-border text-left" style="width:250px !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $value['supplier'] }}</td>
              @elseif ($data_cat->id == 18)
              ...
              @elseif ($data_cat->id == 2 || $data_cat->id == 7 || $data_cat->id == 16 || $data_cat->id == 10)
                <td class="bottom-thin-border text-right">{{ $value['payee'] }}</td>
              @elseif ($data_cat->id == 3)
                <td class="bottom-thin-border text-right">{{ $value['payee'] }}</td>
            ...
            @if ($data_cat->id == 16 || $data_cat->id == 5 || $data_cat->id == 8)
             <td class="bottom-thin-border text-left"  style="width:150px !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $value['remarks']}}</td>
             <td class="bottom-thin-border text-left" style="border-right:1px solid #000;width:120px !important;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            @elseif ($data_cat->id == 3)
             <td class="bottom-thin-border text-left"  style="width:80px !important;">{{ $value['remarks']}}</td>
             <td class="bottom-thin-border text-left" style="border-right:1px solid #000;width:50px !important;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            @elseif ($data_cat->id == 10 )
             <td class="bottom-thin-border text-left"  style="width:200px !important;">{{ $value['remarks']}}</td>
             <td class="bottom-thin-border text-left" style="border-right:1px solid #000;width:100px !important;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            @else
             <td class="bottom-thin-border text-left"  style="width:100px !important;">{{ $value['remarks']}}</td>
             <td class="bottom-thin-border text-left" style="border-right:1px solid #000;width:90px !important;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
